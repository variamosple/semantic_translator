#+title: Prolog adapter for the semantic translator
#+author: 

#+begin_src python :session s1 :results yes :tangle prolog_bridge.py
...
#+begin_src python :session s1 :results none :exports none :tangle prolog_bridge.py
